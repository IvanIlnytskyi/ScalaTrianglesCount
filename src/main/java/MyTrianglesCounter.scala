...
// THIS IS MY WRAPPER TO COUNT THE TRIANGLES AND THE METHOD RETURNS THE COUNT
object MyTrianglesCounterWrapper {

  def doTheJob[VD: ClassTag, ED: ClassTag](graph: Graph[VD, ED]): Int = {
